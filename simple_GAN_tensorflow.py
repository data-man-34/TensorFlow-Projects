...
# Simple Generative Adversarial Networks: Approximating a 1-dimensional Gaussian distribution.
...
class DataDistribution(object):
    def __init__(self):
        # set the mean and standard deviation of the real sample distrbution
        self.mu = 4
        self.sigma = 0.5

    def sample(self, N):
        # normally distribute N samples according to previous settings
...
class GeneratorDistribution(object):
    def __init__(self, range):
        # a stratified sampling within the range
        # as the input noise for the generator
        self.range = range

    def sample(self, N):
        # distribute the sample evenly over the range
        # then plus random constants 
